...
#START_INS
OBJECTS=src/ciphers/aes/aes_enc.o src/ciphers/aes/aes.o src/ciphers/aes/aes_tab.o src/ciphers/anubis.o \
src/ciphers/blowfish.o src/ciphers/camellia.o src/ciphers/cast5.o src/ciphers/des.o src/ciphers/kasumi.o \
...
src/ciphers/twofish/twofish_tab.o src/ciphers/xtea.o src/encauth/ccm/ccm_memory.o \
...
src/hashes/sha2/sha512.o src/hashes/tiger.o src/hashes/whirl/whirl.o src/hashes/whirl/whirltab.o \
...
src/prngs/rng_get_bytes.o src/prngs/rng_make_prng.o src/prngs/sober128.o src/prngs/sober128tab.o \
